...
#### 2021-JUN-XX [TBA](https://www.meetup.com/calgaryr/events/){target="_blank"}
...
#### 2021-JUL-XX [Title: TBA](https://www.meetup.com/calgaryr/events/){target="_blank"}

+ Speaker: [<b>Danielle Clake</b>](email:danielle.clake@ucalgary.ca){target="_blank"}
+ Location: Online Event

\


#### 2021-AUG-XX [TBA](https://www.meetup.com/calgaryr/events/){target="_blank"}

+ Speaker: [<b>Volunteer</b>](){target="_blank"}
+ Location: Online Event


#### 2021-SEP-XX [TBA](https://www.meetup.com/calgaryr/events/){target="_blank"}

+ Speaker: [<b>Cherri Zhang</b>](){target="_blank"}
+ Location: Online Event

...
* September 5, 2019 - nonlinear modeling with R, led by chel  
    ...
    + polynomial, smoth, MM, gompertz, logistic 
    + target audience:
    + [RSVP at meetup] (maximum capacity 30)

<br>

* October 3, 2019 - preprocessing with R, led by chel 

    + data structure, manipulation and cleaning techniques, outlier detection, systematic errors, maintainence, etc

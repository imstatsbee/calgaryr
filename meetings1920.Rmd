...
* 2019-SEP-18 [title1/title2](){target="_blank"}
    ...
    + Talk 1: **Burning out of Time: Power-Plant Decommissions and Mine Cloures in the Appalachians**, by Reinaldo Viccini <<reinaldo.viccini@ucalgary.ca>> 
...
* 2019-OCT-16 [title1 / title2](){target="_blank"}
    ...
    + Talk 1: Title, by David Chan (confirmed)
    
    Waiting for abstract 
    
    + Talk 2: Title, by Naoko Tomioka (confirmed)
